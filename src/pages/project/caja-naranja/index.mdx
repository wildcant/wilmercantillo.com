...
description:
  'Construcción de una aplicacion web para ofrecer un servicio de almacenamiento
  escalable bajo demanda en bodegas.'
category: 'Retail'
projectType: 'StartUp'
tech: 'Angular & Node'
keywords:
...
Este proyecto lo desarrolle en conjunto con un amigo, como una idea de negocio y
