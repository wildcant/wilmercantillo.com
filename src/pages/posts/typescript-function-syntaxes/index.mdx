export const metadata = {
  slug: 'typescript-function-syntaxes',
  title: 'TypeScript Function Syntaxes',
  date: '2021-02-25',
  author: 'Kent C. Dodds',
  description:
    '_The syntax for various functions and function types in TypeScript with simple examples._',
...
[my friend Peter](https://twitter.com/aprillion_0042) who originally showed this
to me):
